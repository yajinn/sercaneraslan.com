                <h1>XHTML Özel Karakterler - Entities</h1>
                <p> Bazı karakterler XHTML tarafından özel karakterler olarak saklı tutulmaktadır. Bu karakterleri XHTML içinde kullanamıyorsunuz çünkü XHTML bu karakterleri kod olarak algılayabiliyor. Eğer bu karakterleri sayfanızda kullanmak istiyorsanız aşağıdaki öğe adı karşılığını veya öğe numarası karşılığını sayfanıza ekleyebilirsiniz.</p>
                <h2>ISO-8859-1</h2>
                <table>
                    <tr>
                      <th>Karakter</th>
                ...
                <a href="/xhtml/index.php?page=url_karakter" class="nextButton">Devam Et</a>                
                <!-- #nextButton -->